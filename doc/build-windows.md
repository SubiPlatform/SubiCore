...
3. Complete Installation
  ...
  * Create a new USUBI user account (this is a separate account from your Windows account)
...
for Ubuntu Xenial does not produce working executables for some of the Subi Core applications.
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/subi/subi.git
    sudo chmod -R a+rw subi
...
causes two of the subi executables to crash shortly after start up. The bug is related to the
...
It's not possible to build the subi code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the subi source code).
