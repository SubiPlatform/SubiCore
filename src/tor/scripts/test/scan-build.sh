...
CHECKERS="\
    ...
    -enable-checker alpha.usubi.BlockInCriticalSection \
    -enable-checker alpha.usubi.Chroot \
    -enable-checker alpha.usubi.PthreadLock \
    -enable-checker alpha.usubi.PthreadLock \
    -enable-checker alpha.usubi.SimpleStream \
    -enable-checker alpha.usubi.Stream \
    -enable-checker alpha.usubi.cstring.BufferOverlap \
    -enable-checker alpha.usubi.cstring.NotNullTerminated \
...
EXTRA_CHECKERS="\
    ...
    -enable-checker alpha.usubi.cstring.OutOfBounds \
...
# Needs work
#    -enable-checker alpha.usubi.MallocWithAnnotations
