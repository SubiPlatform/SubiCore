...
rend_service_port_config_new(const char *socket_path)
{
  ...
  memcpy(conf->usubi_addr, socket_path, pathlen);
  conf->is_usubi_addr = 1;
  return conf;
}
