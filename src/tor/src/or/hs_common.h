...
typedef struct rend_service_port_config_t {
  ...
  unsigned int is_usubi_addr:1;
  /* The outgoing TCP port to use, if !is_usubi_addr */
  uint16_t real_port;
  /* The outgoing IPv4 or IPv6 address to use, if !is_usubi_addr */
  tor_addr_t real_addr;
  /* The socket path to connect to, if is_usubi_addr */
