...
std::string GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-stakecombinethreshold=<n>", _("Minimum amount of SUBI to combine into one stake if wallet has multiple outputs to stake. (default: 5000)"));
