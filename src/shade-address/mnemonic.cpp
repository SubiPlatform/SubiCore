...
#include <shade-address/mnemonic.h>
...
#include <shade-address/wordlists/english.h>
#include <shade-address/wordlists/french.h>
#include <shade-address/wordlists/japanese.h>
#include <shade-address/wordlists/spanish.h>
#include <shade-address/wordlists/chinese_simplified.h>
#include <shade-address/wordlists/chinese_traditional.h>
#include <shade-address/wordlists/italian.h>
#include <shade-address/wordlists/korean.h>
...
int MnemonicEncode(int nLanguage, const std::vector<uint8_t> &vEntropy, std::string &sWordList, std::string &sError)
{
    ...
    if (nLanguage == WLL_JAPANESE)
        subi::ReplaceStrInPlace(sWordList, " ", "\u3000");
