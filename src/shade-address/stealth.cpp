...
//#include <shade-address/smsg/crypter.h>
#include <shade-address/stealth.h>
//#include <shade-address/smsg/smessage.h>
#include <base58.h>
#include <crypto/sha256.h>
#include <shade-address/keyutil.h>
#include <key.h>
#include <pubkey.h>
#include <random.h>
...
bool CShadeAddress::SetEncoded(const std::string& encodedAddress)
{
    data_chunk raw;
...
std::string CShadeAddress::Encoded() const
{
    // https://wiki.unsystem.net/index.php/DarkWallet/Stealth#Address_format
    // [version] [options] [scan_key] [N] ... [Nsigs] [prefix_length] ...
...
bool IsShadeAddress(const std::string& encodedAddress)
{
    data_chunk raw;
