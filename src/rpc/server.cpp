...
{ //  category              name                      actor (function)         argNames
  ...
  /* Subinode features */
  { "Subinode",               "subinode",             &subinode,             {"command"}  },
  { "Subinode",               "subinodesync",         &subinodesync,             {"command"}  },
  { "Subinode",               "subinodelist",         &subinodelist,         {"mode", "filter"}  },
  { "Subinode",               "subinodebroadcast",    &subinodebroadcast,    {"command"}  },
  { "Subinode",               "getpoolinfo",          &getpoolinfo,            {}  },
};
