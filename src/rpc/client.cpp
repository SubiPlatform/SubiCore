...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    //SUBI Privacy functions
    { "setmininput", 0 , "amount"},
    { "shadeamount", 0 , "amount"},
    { "unshadeamount", 0 , "amount"},
    { "setgenerate", 0 , "bool"},
    { "setgenerate", 1 , "bool"},
    { "setshadedsubistatus", 2 ,""},
    { "setshadedsubistatus", 1 ,""},
    { "listunspentshadedsubi", 0 ,""},
    { "listpubcoins", 0, ""},
    ...
    {"refillshadekeys", 0, "amount"},
    {"listshadedsubi", 0, "all"},
