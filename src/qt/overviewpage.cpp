...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance, const CAmount& shadeBalance, const CAmount& shadeBalanceUnconfirmed, const CAmount& staked, const CAmount& watchStakedBalance)
{
    int unit = walletModel->getOptionsModel()->getDisplayUnit();
    currentBalance = balance;
    currentUnconfirmedBalance = unconfirmedBalance;
    currentShadeBalance = shadeBalance;
    currentShadeBalanceUnconfirmed = shadeBalanceUnconfirmed;
    ...
    ui->labelShade->setText(BitcoinUnits::formatWithUnit(unit, shadeBalance, false, BitcoinUnits::separatorAlways));
    ui->labelShadeUnconfirmed->setText(BitcoinUnits::formatWithUnit(unit, shadeBalanceUnconfirmed, false, BitcoinUnits::separatorAlways));
    ui->labelImmature->setText(BitcoinUnits::formatWithUnit(unit, immatureBalance, false, BitcoinUnits::separatorAlways));
    ui->labelTotal->setText(BitcoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance + shadeBalance , false, BitcoinUnits::separatorAlways));
    ...
    bool showShade = shadeBalance != 0;
    bool showShadeUnconfirmed = shadeBalanceUnconfirmed != 0;
    bool showWatchOnlyImmature = watchImmatureBalance != 0;

    // for symmetry reasons also show immature label when the watch-only one is shown
    ui->labelImmature->setVisible(showImmature || showWatchOnlyImmature);
    ui->labelShade->setVisible(showShade);
    ui->labelShadeText->setVisible(showShade);
    ui->labelWatchShade->setVisible(false);
    ui->labelShadeUnconfirmed->setVisible(showShadeUnconfirmed);
    ui->labelShadeUnconfirmedText->setVisible(showShadeUnconfirmed);
    ui->labelWatchShadeUnconfirmed->setVisible(false);
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    if(model && model->getOptionsModel())
    {
        ...
        setBalance(model->getBalance(), model->getUnconfirmedBalance(), model->getImmatureBalance(),
                   model->getWatchBalance(), model->getWatchUnconfirmedBalance(), model->getWatchImmatureBalance(), model->getShadeBalance(), model->getShadeBalanceUnconfirmed(), model->getStakeBalance(), model->getReservedBalance());
    ...
    if(walletModel && walletModel->getOptionsModel())
    {
        if(currentBalance != -1){
            setBalance(currentBalance, currentUnconfirmedBalance, currentImmatureBalance,
                       currentWatchOnlyBalance, currentWatchUnconfBalance, currentWatchImmatureBalance, currentShadeBalance, currentShadeBalanceUnconfirmed, currentStaked, currentWatchStakedBalance);
