...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinSubinodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
    vinSubinode = vinSubinodeIn;
    vchSig = vchSigIn;
...
{
    CSubinode* pmn = mnodeman.GetSubinodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
