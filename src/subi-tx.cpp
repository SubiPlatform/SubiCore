...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s subi-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  subi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded subi transaction") + "\n" +
              "  subi-tx [options] -create [commands]   " + _("Create hex-encoded subi transaction") + "\n" +
              "\n";
